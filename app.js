...
gsap.from('.abt-img',{opacity: 0, duration: 1, delay:1, y:30, stagger:0.3})
gsap.from('.abt',{opacity: 0, duration: 1, delay:1.5, y:30, stagger:0.3})
gsap.from('.work-heading h1',{opacity: 0, duration: 1, delay:1.3, y:30, stagger:0.3})
gsap.from('.work-heading p',{opacity: 0, duration: 1, delay:1.5, y:30, stagger:0.3})
gsap.from('.work-card-1',{opacity: 0, duration: 1, delay:1.6, y:30, stagger:0.3})
gsap.from('.work-card-2',{opacity: 0, duration: 1, delay:1.7, y:30, stagger:0.3})
gsap.from('.work-card-3',{opacity: 0, duration: 1, delay:1.9, y:30, stagger:0.3})
...
gsap.from('.contact',{opacity: 0, duration: 1, delay:1, y:30, stagger:0.3})
